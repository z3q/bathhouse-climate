...
### Управление
* Режим отъезда: чтобы выключить все нагревательные приборы и кондиционер, нужно 3 раза за 5 секунд включить свет. Режим отъезда активируется на 10 минут, сбрасывая в 0 флаг присутствия за 12 часов. Сигналом режима отъезда является мигание зелёного индикатора (F1) с частотой 2 Гц.
...
* контакт открытия форточки (геркон) через WB-MIRv2;
